(function (c) {
    ...
    a.define('/gif.coffee', function (b, k, j, i) {
        ...
        var e, d, f;
        d = a('events', b).EventEmitter, e = a('/browser.coffee', b), f = function (f, b, d) {
            function a(d) {
                var a, c;
            ...
            return h(a, f), b = {
                ...
                return function (d) {
                    ...
                    for (b in a) {
                        if (!c(a, b)) continue;
                        e = a[b], d.push(this.setOption(b, e))
                    }
                    return d
                }.call(this, [])
                ...
                var b, e;
                null == c && (c = {}), b = {};
                for (e in d) b[e] = c[e] || d[e];
                if (null != this.options.width || this.setOption('width', a.width), null != this.options.height || this.setOption('height', a.height), 'undefined' !== typeof ImageData && null != ImageData && a instanceof ImageData) b.data = a.data;
                else if ('undefined' !== typeof CanvasRenderingContext2D && null != CanvasRenderingContext2D && a instanceof CanvasRenderingContext2D || 'undefined' !== typeof WebGLRenderingContext && null != WebGLRenderingContext && a instanceof WebGLRenderingContext) c.copy ? b.data = this.getContextData(a) : b.context = a;
                else if (null != a.childNodes) c.copy ? b.data = this.getImageData(a) : b.image = a;
                ...
                this.running = !0, this.nextFrame = 0, this.finishedFrames = 0, this.imageParts = function (c) {
                    ...
                    for (var b = function () {
                        ...
                        return b
                    }.apply(this, arguments), a = 0, d = b.length; a < d; ++a) e = b[a], c.push(null);
                    return c
                ...
                for (var c = function () {
                    ...
                    return c
                }.apply(this, arguments), b = 0, d = c.length; b < d; ++b) e = c[b], this.renderNextFrame();
                ...
                return console.log('frame ' + a.index + ' finished - ' + this.activeWorkers.length + ' active'), this.finishedFrames++, this.emit('progress', this.finishedFrames / this.frames.length), this.imageParts[a.index] = a, g(null, this.imageParts) ? this.renderNextFrame() : this.finishRendering()
...
// gif.js 0.1.5 - https://github.com/jnordberg/gif.js